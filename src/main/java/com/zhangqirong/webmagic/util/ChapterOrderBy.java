...
public class ChapterOrderBy {
    ...
    public static void main(String[] args) {
        String string = "第四十三章：成为百万富翁的秘诀（求推荐票！）";
        long ordBy = ChapterOrderBy.chnNum2Digit(string);
        if (ordBy  == 0) {
            ordBy =Long.parseLong( ChapterOrderBy.getNumbers(string));
        }
//        ordBy = numbers;
...
//                }
                ...
                // 不存在"亿"或"万"情况，临时变量值put到map
                    ...
                    tempNum = 0;
                    dataMap.put("个", (long)0);dataMap.put("个", (long)0);
                }
            } else if (bit == '十') {
